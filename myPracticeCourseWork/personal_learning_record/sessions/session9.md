...
Very small area (e.g., your phone and Bluetooth devices) Key Networking Devices
Router

Connects networks together (e.g., your home network to the internet).

Switch

Connects multiple devices within a network and directs traffic efficiently.

Access Point (AP)

Provides wireless connectivity (Wi-Fi). Networking allows us to:
...
Store and access data on servers

Connect smart devices (IoT),  IP Address

A unique number identifying a device on a network (like a postal address).

MAC Address

A permanent hardware identifier for network devices.
